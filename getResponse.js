...
var vocabulary = [
    ...
    ['what do you do in space', ['On a daily basis, I check the equipment on the spaceship, and perform tests on items from space', 'I perform maintenance and testing on this spacecraft'], 'jobs'],
    ['what do you eat', 'Food in space is usually freeze dried and nutrient heavy blocks. Astronauts can also request things like Pizza and Ice Cream', 'eat'],
    ['when are you coming back', 'Usually, I spend between 1-3 years in space before coming back to Earth. Resource limitations are the main reason why I need to return.', 'return'],
...
function stemInput(input) {
    ...
    // return new stemmed output with spaces!!!
    return stemOut;
}
